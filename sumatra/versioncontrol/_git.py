...
#                                                                            #
#    The code below redefines two functions from GitPython to provide the    #
#    necessary hooks to support dirty directories                            #
#                                                                            #
##############################################################################
...
def is_dirty(
    ...
    ignored_paths = [Path(path).expanduser() for path in ignored_paths]
...
class GitWorkingCopy(WorkingCopy):
    ...
    def use_version(self, version):
        ...
        # if version != 'master':             # AR: I don’t see why excluding the 'master' branch from checking is a good idea, especially since most repos now use 'main' instead. I have used SumatraTask for years on a repo with no 'master' branch and have not run into issues.
